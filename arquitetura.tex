...
\titulo{Arquitetura para APIs de Machine Learning}
...
\include{topics/sumario}

\mainmatter

\include{topics/introducao}
\include{topics/sd}
\include{topics/apdmaq}
%\include{topics/problematica}
%\include{topics/classificador}
\include{topics/objecoes}
\include{topics/conclusao}
\include{topics/bibliografia}
%\include{apendice}
%\include{anexos}
